 ...
 * </p>
 * <ul>
 *   <li>{@link edu.upb.lp.isc.pole.Operacion#getIzq <em>Izq</em>}</li>
 *   <li>{@link edu.upb.lp.isc.pole.Operacion#getDer <em>Der</em>}</li>
 * </ul>
 *
 * @see edu.upb.lp.isc.pole.PolePackage#getOperacion()
 * @model
 * @generated
 */
public interface Operacion extends EObject
{
   ...
   * @see edu.upb.lp.isc.pole.PolePackage#getOperacion_Izq()
  ...
  /**
   * Sets the value of the '{@link edu.upb.lp.isc.pole.Operacion#getIzq <em>Izq</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see edu.upb.lp.isc.pole.PolePackage#getOperacion_Der()
   * @model containment="true"
   * @generated
   */
  Expresion getDer();
  ...
  /**
   * Sets the value of the '{@link edu.upb.lp.isc.pole.Operacion#getDer <em>Der</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
